...
🎥 **Próximamente nuevo canal de [YouTube](https://youtube.com/pauogdev)** (tutoriales, desarrollo en vivo y análisis técnico).
<br>
...
- **[API en Go para gestión de figuras de anime](https://github.com/pauogdev/GeenkCollectorFigure-Backend)**: Backend desarrollado en Go con autenticación JWT y Firebase.
- **[Apps Android con Kotlin y Compose](https://github.com/pauogdev/Curso-Kotlin-AristiDevs)**: Ejemplos de aplicaciones móviles con Jetpack Compose.
- **Web [pauog.dev](https://github.com/pauogdev/Portfolio-Astro)**: Enfocada a un portfolio para encontrar trabajo.
- **Próximo lanzamiento: Nueva web [pauog.dev](https://pauog.dev)**: Reestructuración con enfoque en servicios de desarrollo y contenido técnico.
- **Próximo lanzamiento: [LuminaKT.com](https://luminakt.com)**: Plataforma para mostrar y vender apps Android con características premium.
...
📺 **YouTube**: [youtube.com/pauogdev](https://youtube.com/pauogdev).<br>
...
- 🎥 **Crear contenido en [YouTube](https://youtube.com/pauogdev)**: Tutoriales, desarrollo en vivo y análisis técnico para la comunidad de desarrolladores.
